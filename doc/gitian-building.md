...
*Setup instructions for a Gitian build of Chaucha Core using a Debian VM or physical system.*
...
- [Building Chaucha Core](#building-chaucha-core)
...
To build Chaucha Core (for Linux, OS X and Windows) just follow the steps under 'perform
...
Output from `gbuild` will look something like
    ...
    From https://github.com/chaucha-project/chaucha
