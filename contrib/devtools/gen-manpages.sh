...
LITECOIND=${LITECOIND:-$SRCDIR/chauchad}
LITECOINCLI=${LITECOINCLI:-$SRCDIR/chaucha-cli}
LITECOINTX=${LITECOINTX:-$SRCDIR/chaucha-tx}
LITECOINQT=${LITECOINQT:-$SRCDIR/qt/chauchera}
