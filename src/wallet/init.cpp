...
std::string GetWalletHelpString(bool showDebug)
{
    ...
    strUsage += HelpMessageOpt("-addresstype", strprintf("What type of addresses to use (\"legacy\", default: \"%s\")", FormatOutputType(OUTPUT_TYPE_DEFAULT)));
    strUsage += HelpMessageOpt("-changetype", "What type of change to use (\"legacy\"). Default is same as -addresstype)");
